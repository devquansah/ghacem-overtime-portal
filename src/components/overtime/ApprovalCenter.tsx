          ...
          {currentReq ? (
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                  ...
                  <table className="w-full text-xs">
                    <thead className="bg-zinc-50 border-b text-[10px] font-extrabold text-zinc-500 uppercase">
                      <tr>
                        ...
                        <th className="p-2 border-r">Start Time</th>
                        <th className="p-2 border-r">End Time</th>
                    ...
                    <tbody>
                      {currentReq.rows.map((row, idx) => (
                        <tr key={idx} className="border-b last:border-b-0">
                          ...
                          <td className="p-2 border-r font-semibold text-zinc-600">{row.startTime}</td>
                          <td className="p-2 border-r font-semibold text-zinc-600">{row.endTime}</td>
                ...
                <div className="flex justify-end items-center bg-zinc-50 p-2.5 rounded border border-zinc-200 text-xs">
                  <span className="font-extrabold text-zinc-900">Total hours: {currentReq.totalHours.toFixed(2)}</span>
                </div>
              </div>
